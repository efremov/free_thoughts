...
class ThoughtsControllerTest < ActionController::TestCase
  ...
  test "should create thought" do
    assert_difference('Thought.count') do
      post :create, thought: { point: @thought.point, quastion_id: @thought.quastion_id, rate: @thought.rate, user_id: @thought.user_id }
    end
  ...
  test "should update thought" do
    put :update, id: @thought, thought: { point: @thought.point, quastion_id: @thought.quastion_id, rate: @thought.rate, user_id: @thought.user_id }
    assert_redirected_to thought_path(assigns(:thought))
  end

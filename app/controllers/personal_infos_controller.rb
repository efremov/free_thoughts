  ...
  def create
    ...
    respond_to do |format|
      if @personal_info.save
        format.html { redirect_to user_personal_infos_path(current_user), notice: 'Personal info was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @personal_info.update_attributes(params[:personal_info])
        format.html { redirect_to user_personal_infos_path(current_user), notice: 'Personal info was successfully updated.' }
